  ...
  const cells: Cell[] = [
    {
      symbol: "Cu",
      name: "Bronce",
      visits: settings.bronze_visits,
      discount: settings.bronze_discount,
    },
    {
      symbol: "Ag",
      name: "Plata",
      visits: settings.silver_visits,
      discount: settings.silver_discount,
    },
    { symbol: "Au", name: "Oro", visits: settings.gold_visits, discount: settings.gold_discount },
    {
      symbol: "Hs",
      name: "Heisenberg",
      visits: settings.heisenberg_visits,
      discount: settings.heisenberg_discount,
    },
  ];
  return (
          ...
          >
            ...
            <div
              className={cn(
                ...
                active ? "text-crystal" : "text-foreground",
              )}
            >
              {c.symbol}
            </div>
